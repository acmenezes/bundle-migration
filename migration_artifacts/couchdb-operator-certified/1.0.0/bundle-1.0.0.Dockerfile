...
COPY migration_artifacts/couchdb-operator-certified/1.0.0/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.0/metadata /metadata/
