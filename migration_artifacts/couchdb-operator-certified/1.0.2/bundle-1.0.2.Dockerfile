...
COPY migration_artifacts/couchdb-operator-certified/1.0.2/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.2/metadata /metadata/
