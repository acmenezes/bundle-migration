...
COPY migration_artifacts/couchdb-operator-certified/1.0.10/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.10/metadata /metadata/
