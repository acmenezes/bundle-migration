...
COPY migration_artifacts/appsody-operator-certified/0.3.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.3.0/metadata /metadata/
