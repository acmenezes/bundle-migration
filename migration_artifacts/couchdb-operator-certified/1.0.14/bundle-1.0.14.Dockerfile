...
COPY migration_artifacts/couchdb-operator-certified/1.0.14/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.14/metadata /metadata/
