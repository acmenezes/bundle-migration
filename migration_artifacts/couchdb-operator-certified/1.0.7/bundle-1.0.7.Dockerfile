...
COPY migration_artifacts/couchdb-operator-certified/1.0.7/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.7/metadata /metadata/
