...
COPY migration_artifacts/couchdb-operator-certified/1.0.6/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.6/metadata /metadata/
