...
COPY migration_artifacts/appsody-operator-certified/0.5.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.5.0/metadata /metadata/
