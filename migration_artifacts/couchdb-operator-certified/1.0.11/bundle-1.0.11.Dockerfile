...
COPY migration_artifacts/couchdb-operator-certified/1.0.11/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.11/metadata /metadata/
