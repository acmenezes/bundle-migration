...
COPY migration_artifacts/appsody-operator-certified/0.2.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.2.0/metadata /metadata/
