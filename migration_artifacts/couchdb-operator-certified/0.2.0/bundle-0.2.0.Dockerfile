...
COPY migration_artifacts/couchdb-operator-certified/0.2.0/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/0.2.0/metadata /metadata/
