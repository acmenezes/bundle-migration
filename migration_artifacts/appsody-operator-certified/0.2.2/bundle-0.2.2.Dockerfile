...
COPY migration_artifacts/appsody-operator-certified/0.2.2/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.2.2/metadata /metadata/
