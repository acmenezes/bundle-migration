...
COPY migration_artifacts/couchdb-operator-certified/1.0.13/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.13/metadata /metadata/
