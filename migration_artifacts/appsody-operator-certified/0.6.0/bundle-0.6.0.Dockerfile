...
COPY migration_artifacts/appsody-operator-certified/0.6.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.6.0/metadata /metadata/
