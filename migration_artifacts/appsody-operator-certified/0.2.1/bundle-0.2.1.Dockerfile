...
COPY migration_artifacts/appsody-operator-certified/0.2.1/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.2.1/metadata /metadata/
