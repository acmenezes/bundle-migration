...
COPY migration_artifacts/appsody-operator-certified/0.4.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.4.0/metadata /metadata/
