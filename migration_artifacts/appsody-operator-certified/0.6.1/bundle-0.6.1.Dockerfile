...
COPY migration_artifacts/appsody-operator-certified/0.6.1/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.6.1/metadata /metadata/
