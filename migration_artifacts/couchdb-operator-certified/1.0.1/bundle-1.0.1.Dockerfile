...
COPY migration_artifacts/couchdb-operator-certified/1.0.1/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.1/metadata /metadata/
