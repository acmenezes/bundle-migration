...
COPY migration_artifacts/appsody-operator-certified/0.1.0/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.1.0/metadata /metadata/
