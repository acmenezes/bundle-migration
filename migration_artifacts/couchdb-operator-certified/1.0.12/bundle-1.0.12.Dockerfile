...
COPY migration_artifacts/couchdb-operator-certified/1.0.12/manifests /manifests/
COPY migration_artifacts/couchdb-operator-certified/1.0.12/metadata /metadata/
