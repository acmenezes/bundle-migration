...
COPY migration_artifacts/appsody-operator-certified/0.5.1/manifests /manifests/
COPY migration_artifacts/appsody-operator-certified/0.5.1/metadata /metadata/
